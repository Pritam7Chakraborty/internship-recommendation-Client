    ...
    <div className="space-y-4">
      <div className="relative">
        ...
        <div className="relative">
          ...
          <input
            type="text"
            className={`w-full pl-12 pr-4 py-2.5 bg-gray-50 dark:bg-gray-700/50 border-2 ${
              validationErrors.username
                ? "border-red-300 dark:border-red-600"
                : "border-gray-200 dark:border-gray-600"
            } rounded-xl text-gray-900 dark:text-white focus:border-blue-500 transition-all`}
      ...
      <div className="relative">
        ...
        <div className="relative">
          ...
          <input
            ...
            className={`w-full pl-12 pr-12 py-2.5 bg-gray-50 dark:bg-gray-700/50 border-2 ${
    ...
    <div className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="relative">
          ...
          <input
            type="text"
            className={`w-full pl-4 pr-4 py-2.5 bg-gray-50 dark:bg-gray-700/50 border-2 ${
      ...
      <div className="relative">
        ...
        <div className="relative">
          <input
            type={showPassword ? "text" : "password"}
            className={`w-full pl-4 pr-12 py-2.5 bg-gray-50 dark:bg-gray-700/50 border-2 ${
              validationErrors.password
                ? "border-red-300"
                : "border-gray-200 dark:border-gray-600"
            } rounded-xl text-gray-900 dark:text-white focus:border-blue-500 transition-all`}
          ...
          <select
            className={`w-full pl-4 pr-4 py-2.5 bg-gray-50 dark:bg-gray-700/50 border-2 ${
              validationErrors.education
                ? "border-red-300"
                : "border-gray-200 dark:border-gray-600"
            } rounded-xl text-gray-900 dark:text-white focus:border-blue-500 transition-all appearance-none`}
            ...
            <div className="mb-4 animate-fadeIn">
              <div className="p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700/50 rounded-lg shadow-sm backdrop-blur-sm">
                <div className="flex items-center space-x-2">
                  ...
                  <p className="text-red-700 dark:text-red-300 font-medium text-xs">
                    {formMessage}
                  </p>
                </div>
              </div>
